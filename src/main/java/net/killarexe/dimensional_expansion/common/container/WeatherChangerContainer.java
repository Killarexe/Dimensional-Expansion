...
public class WeatherChangerContainer extends AbstractContainerMenu {

    private final BlockEntity blockEntity;
    private final Player player;
    private final IItemHandler playerInv;

    public WeatherChangerContainer(int windId, Level world, BlockPos pos, Inventory playerInv, Player player) {
        super(DEContainers.WEATHER_CHANGER_CONTAINER.get(), windId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), player, DEBlocks.WEATHER_CHANGER.get());
    }
