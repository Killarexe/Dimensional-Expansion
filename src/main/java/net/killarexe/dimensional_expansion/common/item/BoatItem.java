...
public class BoatItem extends Item {
    ...
    private final DEBoatEntity.Type type;

    public BoatItem(Properties pProperties, DEBoatEntity.Type type) {
        super(pProperties);
        this.type = type;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if (raytraceresult.getType() == HitResult.Type.MISS) {
            ...
            if (raytraceresult.getType() == HitResult.Type.BLOCK) {
                DEBoatEntity boatentity = new DEBoatEntity(pLevel, raytraceresult.getLocation().x, raytraceresult.getLocation().y, raytraceresult.getLocation().z);
