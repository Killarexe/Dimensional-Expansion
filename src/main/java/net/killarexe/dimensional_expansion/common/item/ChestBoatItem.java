...
public class ChestBoatItem extends Item {
    ...
    private final DEChestBoatEntity.Type type;

    public ChestBoatItem(Properties pProperties, DEChestBoatEntity.Type type) {
        super(pProperties);
        this.type = type;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if (raytraceresult.getType() == HitResult.Type.MISS) {
            ...
            if (raytraceresult.getType() == HitResult.Type.BLOCK) {
            	DEChestBoatEntity boatentity = new DEChestBoatEntity(pLevel, raytraceresult.getLocation().x, raytraceresult.getLocation().y, raytraceresult.getLocation().z);
