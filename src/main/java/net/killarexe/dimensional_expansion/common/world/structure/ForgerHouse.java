...
public class ForgerHouse extends Feature<NoneFeatureConfiguration> {
    ...
    public static Feature FEATURE = new ForgerHouse();
    ...
    public ForgerHouse() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register(DEMod.MODID + ":forger_house", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register(DEMod.MODID + ":forger_house_placed", CONFIGURED_FEATURE, List.of());
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        if (structureTemplate == null)
            structureTemplate = context.level().getLevel().getStructureManager()
                    .getOrCreate(new ResourceLocation(DEMod.MODID, "forger_house"));
