...
public class FarmerHouse extends StructureFeature<JigsawConfiguration> {
    public FarmerHouse() {
        super(JigsawConfiguration.CODEC, FarmerHouse::createPiecesGenerator);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        if (!FarmerHouse.isFeatureChunk(context)) {
