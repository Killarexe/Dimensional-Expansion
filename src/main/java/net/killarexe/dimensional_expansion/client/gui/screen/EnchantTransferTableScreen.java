...
@OnlyIn(Dist.CLIENT)
public class EnchantTransferTableScreen extends AbstractContainerScreen<EnchantTransferTableContainer>{

    private final ResourceLocation GUI = new ResourceLocation(DEMod.MOD_ID, "textures/gui/container/essence_extractor_gui.png");

    public EnchantTransferTableScreen(EnchantTransferTableContainer pMenu, Inventory pPlayerInventory, Component pTitle) {
